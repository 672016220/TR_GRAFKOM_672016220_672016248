...
void Penonton(void){
	...
	//Papan skor
    glBegin(GL_POLYGON);//Skor Point 1
    glColor3d(1,1,1);
    glVertex3d(-54,-5,30);
    glVertex3d(-54,5,30);
    glVertex3d(-54,5,25);
    ...
    glEnd();
    glLineWidth(2);
    glBegin(GL_LINE_LOOP);//Skor Point 1
    glColor3f(0,0,0);
    glVertex3f(-54,-5,30);
    glVertex3f(-54,5,30);
    glVertex3f(-54,5,25);
    ...
    glVertex3d(-54,2,26.5);
    glEnd();
    glBegin(GL_POLYGON);//Skor Point 2
    glColor3d(1,1,1);
    glVertex3d(54,-5,30);
    glVertex3d(54,5,30);
    glVertex3d(54,5,25);
    ...
    glEnd();
    glLineWidth(2);
    glBegin(GL_LINE_LOOP);//Skor Point 2
    glColor3f(0,0,0);
    glVertex3f(54,-5,30);
    glVertex3f(54,5,30);
    glVertex3f(54,5,25);
    ...
    glBegin(GL_POLYGON);//Skor Point 3
    glColor3d(1,1,1);
    glVertex3d(-5,36,30);
    glVertex3d(5,36,30);
    glVertex3d(5,36,25);
    ...
    glEnd();
    glLineWidth(2);
    glBegin(GL_LINE_LOOP);//Skor Point 3
    glColor3f(0,0,0);
    glVertex3f(-5,36,30);
    glVertex3f(5,36,30);
    glVertex3f(5,36,25);
